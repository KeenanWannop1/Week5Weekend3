package com.example.admin.week5weekend.client;
...
import com.example.admin.week5weekend.utils.NetworkHelper;
...
public class OkhttpHelper {
    ...
    public void enqueue(final LatLngCallback latLngCall) {
