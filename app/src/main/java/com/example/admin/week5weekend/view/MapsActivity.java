package com.example.admin.week5weekend.view;

import android.os.Bundle;
import android.support.v4.app.FragmentActivity;
import android.util.Log;

import com.example.admin.week5weekend.R;
import com.example.admin.week5weekend.client.OkhttpHelper;
import com.example.admin.week5weekend.model.data.LocationResponse;
import com.example.admin.week5weekend.utils.LatLngCallback;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        this.googleMap.addMarker(new MarkerOptions().position(location).title("Location"));
